<template>
  <SidebarProvider>
    ...
    <SidebarInset>
      ...
      <!-- Automation page gets full height without padding-bottom so iframe fills viewport -->
      <div
          class="flex flex-1 flex-col gap-4 overflow-y-auto p-3 sm:p-4 lg:p-6"
          :class="{ 'overflow-hidden': isAutomation }"
      >
        <RouterView />
      </div>
    </SidebarInset>
